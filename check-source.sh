...
script=source-estimation-on-evoked.py
...
python $script --mode MEG --file ./output/artificial-by-diff-times/MEG-evoked-target-quick-by-diff-times-ave.fif &
python $script --mode MEG --file ./output/artificial-by-diff-times/MEG-evoked-target-slow-by-diff-times-ave.fif &
python $script --mode MEG --file ./output/artificial-by-diff-times/MEG-evoked-proj-quick-by-diff-times-ave.fif &
python $script --mode MEG --file ./output/artificial-by-diff-times/MEG-evoked-proj-slow-by-diff-times-ave.fif &