"""
File: decoding.1.raw.to.epochs.py
...
OUTPUT_DIR = Path(f'output/decoding-step-1/{MODE}-{SUBJ}')
...
# %% ---- 2026-02-25 ------------------------
# Save epochs
# Save epochs for 1, 2, 3, 4 events separately
...
# Save hilbert epochs for 1, 2, 3, 4 events separately
for evt in ['1', '2', '3', '4']:
