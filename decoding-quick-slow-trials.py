...
Purpose:
    Decoding quick vs. slow target trials.
...
OUTPUT_DIR = Path('./output/decoding-quick-slow-trials/', args.mode, args.subj)
...
X1 = epochs_quick.get_data()
X2 = epochs_slow.get_data()
